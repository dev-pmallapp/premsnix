      ...
      graphical = {
        ...
        apps = {
          thunderbird =
            let
              ...
              outlook = lib.premsnix.decode "a2hhbmVsaW1hbjEyQG91dGxvb2suY29t";
              personal = lib.premsnix.decode "YXVzdGluLm0uaG9yc3RtYW5AZ21haWwuY29t";
              work = lib.premsnix.decode "YXVzdGluLmhvcnN0bWFuQG5yaS1uYS5jb20=";
            in
            {
              accountsOrder = [
        ...
        wms = {
          hyprland = {
            ...
            appendConfig = # bash
              ''
                exec-once = hyprctl setcursor ${config.premsnix.theme.gtk.cursor.name} ${builtins.toString config.premsnix.theme.gtk.cursor.size}
              '';
    ...
    services = {
      hyprpaper = {
        monitors = [
          {
            name = "DP-3";
            wallpaper = "${pkgs.premsnix.wallpapers}/share/wallpapers/cat_pacman.png";
          }
          {
            name = "DP-1";
            wallpaper = "${pkgs.premsnix.wallpapers}/share/wallpapers/cat-sound.png";
          }
        ];

        wallpapers = [
          "${pkgs.premsnix.wallpapers}/share/wallpapers/buttons.png"
          "${pkgs.premsnix.wallpapers}/share/wallpapers/cat_pacman.png"
          "${pkgs.premsnix.wallpapers}/share/wallpapers/cat-sound.png"
          "${pkgs.premsnix.wallpapers}/share/wallpapers/flatppuccin_macchiato.png"
          "${pkgs.premsnix.wallpapers}/share/wallpapers/hashtags-black.png"
          "${pkgs.premsnix.wallpapers}/share/wallpapers/hashtags-new.png"
          "${pkgs.premsnix.wallpapers}/share/wallpapers/hearts.png"
          "${pkgs.premsnix.wallpapers}/share/wallpapers/tetris.png"
        ];
      };
  ...
  programs.hyprlock.settings.background = lib.mkForce (
    let
      mkBackground = monitor: wallpaper: {
        ...
        path = "${pkgs.premsnix.wallpapers}/share/wallpapers/${wallpaper}";
        blur_passes = 3;
        blur_size = 8;
        contrast = "0.891700";
        noise = "0.011700";
